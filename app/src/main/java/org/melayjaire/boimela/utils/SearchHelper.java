...
import org.melayjaire.boimela.search.SearchSuggestionComparator;
import org.melayjaire.boimela.search.algorithm.EditDistance;
...
public class SearchHelper {
     ...
     *
     * @param searchColumn column name for which database cursor will be matched (must
     *                     not be null). pass an empty string to specify no column.
     * @param cursor       database result for the specified search category (must not be
     *                     null)
     * @param filter       query filter for narrowing down search result
     */
